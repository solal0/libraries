...
NexusUI.Themes = {
    ...
    ["obsidian"] = {
        ...
        text_secondary = Color3.fromRGB(180, 180, 190),
        text_disabled = Color3.fromRGB(100, 100, 110),
        accent_primary = Color3.fromRGB(170, 0, 255),
        accent_success = Color3.fromRGB(0, 200, 100),
        accent_warning = Color3.fromRGB(255, 180, 0),
        accent_error = Color3.fromRGB(255, 80, 80),
        accent_info = Color3.fromRGB(100, 180, 255),
        background = Color3.fromRGB(10, 10, 15),
        surface = Color3.fromRGB(25, 25, 35),
        surface_hover = Color3.fromRGB(35, 35, 50),
        surface_active = Color3.fromRGB(45, 45, 65),
        border = Color3.fromRGB(60, 60, 80),
        border_hover = Color3.fromRGB(80, 80, 100),
        divider = Color3.fromRGB(50, 50, 65),
        selection = Color3.fromRGB(170, 0, 255, 0.3),
        scrollbar = Color3.fromRGB(70, 70, 90),
        scrollbar_hover = Color3.fromRGB(90, 90, 110),
        notification_bg = Color3.fromRGB(25, 25, 35, 0.95),
        ...
        notification_info = Color3.fromRGB(100, 180, 255),
        shadow_color = Color3.fromRGB(0, 0, 0, 0.5),
        glow_color = Color3.fromRGB(170, 0, 255, 0.2),
        font = Enum.Font.Gotham,
        font_bold = Enum.Font.GothamBold,
        font_mono = Enum.Font.Code,
        corner_radius = UDim.new(0, 8),
    ...
    ["cyberpunk"] = {
        ...
        tertiary = Color3.fromRGB(40, 40, 70),
        text_primary = Color3.fromRGB(220, 255, 255),
        text_secondary = Color3.fromRGB(180, 220, 220),
        text_disabled = Color3.fromRGB(100, 120, 120),
        accent_primary = Color3.fromRGB(0, 255, 200),
        accent_success = Color3.fromRGB(0, 255, 150),
        accent_warning = Color3.fromRGB(255, 255, 0),
        accent_error = Color3.fromRGB(255, 50, 100),
        accent_info = Color3.fromRGB(100, 200, 255),
        background = Color3.fromRGB(5, 5, 15),
        surface = Color3.fromRGB(20, 20, 40),
        surface_hover = Color3.fromRGB(30, 30, 60),
        surface_active = Color3.fromRGB(40, 40, 80),
        border = Color3.fromRGB(0, 255, 200),
        border_hover = Color3.fromRGB(100, 255, 220),
        divider = Color3.fromRGB(0, 100, 80),
        selection = Color3.fromRGB(0, 255, 200, 0.3),
        scrollbar = Color3.fromRGB(0, 200, 160),
        scrollbar_hover = Color3.fromRGB(0, 230, 190),
        notification_bg = Color3.fromRGB(20, 20, 40, 0.95),
        notification_border = Color3.fromRGB(0, 255, 200),
        notification_success = Color3.fromRGB(0, 255, 150),
        notification_warning = Color3.fromRGB(255, 255, 0),
        notification_error = Color3.fromRGB(255, 50, 100),
        notification_info = Color3.fromRGB(100, 200, 255),
        shadow_color = Color3.fromRGB(0, 0, 0, 0.5),
        glow_color = Color3.fromRGB(0, 255, 200, 0.2),
        font = Enum.Font.Code,
        font_bold = Enum.Font.Code,
        font_mono = Enum.Font.Code,
    ...
    ["matrix"] = {
        ...
        tertiary = Color3.fromRGB(0, 60, 0),
        text_primary = Color3.fromRGB(0, 255, 100),
        text_secondary = Color3.fromRGB(0, 200, 80),
        text_disabled = Color3.fromRGB(0, 100, 40),
        accent_primary = Color3.fromRGB(0, 255, 0),
        accent_success = Color3.fromRGB(0, 255, 100),
        accent_warning = Color3.fromRGB(255, 255, 0),
        accent_error = Color3.fromRGB(255, 0, 0),
        accent_info = Color3.fromRGB(0, 200, 255),
        background = Color3.fromRGB(0, 10, 0),
        surface = Color3.fromRGB(0, 30, 0),
        surface_hover = Color3.fromRGB(0, 50, 0),
        surface_active = Color3.fromRGB(0, 70, 0),
        border = Color3.fromRGB(0, 255, 0),
        border_hover = Color3.fromRGB(100, 255, 100),
        divider = Color3.fromRGB(0, 100, 0),
        selection = Color3.fromRGB(0, 255, 0, 0.3),
        scrollbar = Color3.fromRGB(0, 200, 0),
        scrollbar_hover = Color3.fromRGB(0, 230, 0),
        notification_bg = Color3.fromRGB(0, 30, 0, 0.95),
        notification_border = Color3.fromRGB(0, 255, 0),
        notification_success = Color3.fromRGB(0, 255, 100),
        notification_warning = Color3.fromRGB(255, 255, 0),
        notification_error = Color3.fromRGB(255, 0, 0),
        notification_info = Color3.fromRGB(0, 200, 255),
        shadow_color = Color3.fromRGB(0, 0, 0, 0.5),
        glow_color = Color3.fromRGB(0, 255, 0, 0.2),
        font = Enum.Font.Code,
        font_bold = Enum.Font.Code,
        font_mono = Enum.Font.Code,
        corner_radius = UDim.new(0, 0),
        border_size = 1,
        padding_small = 4,
        padding_medium = 8,
        padding_large = 12,
